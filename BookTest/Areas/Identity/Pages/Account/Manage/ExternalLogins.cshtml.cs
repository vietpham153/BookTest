...
namespace BookTest.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostRemoveLoginAsync(string loginProvider, string providerKey)
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Đăng nhập bên thứ 3 không bị xóa.";
                return RedirectToPage();
            }

            await _signInManager.RefreshSignInAsync(user);
            StatusMessage = "Đăng nhập bên thứ 3 đã bị xóa.";
            return RedirectToPage();
        }
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Không thêm được thông tin đăng nhập bên thứ 3. Thông tin đăng nhập bên ngoài chỉ có thể được liên kết với một tài khoản.";
                return RedirectToPage();
            }
            ...
            StatusMessage = "Đăng nhập bên thứ 3 đã được thêm";
            return RedirectToPage();
        }
    }
}
