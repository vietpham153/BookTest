...
namespace BookTest.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{Name} đã đăng nhập với {LoginProvider} nhà cung cấp.", info.Principal.Identity.Name, info.LoginProvider);
        ...
        private IdentityUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Không thể tạo một phiên bản của '{nameof(IdentityUser)}'. " +
                    $"Chắc chắn rằng '{nameof(IdentityUser)}' không phải là một lớp trừu tượng và có một hàm tạo không tham số, hoặc thay vào đó " +
